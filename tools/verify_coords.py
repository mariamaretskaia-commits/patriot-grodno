...
def main() -> int:
    ...
    lines += [
        ...
        "- У мемориала пограничникам, комплекса в Сморгони, «Детей лихолетья» в Дятлово,",
        "  орудия в Волковыске и братской могилы в Юратишках координаты привязаны",
        "  к населённому пункту: в OpenStreetMap сами объекты не размечены.",
        "",
    ]
